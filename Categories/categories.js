async function check(){
    ...
    let category = document.getElementById("category").innerHTML.toLowerCase();
    ...
    jso.map(x => {
        if(x.category == category){
            ...
            <a href="#">
                <img class="p-8 rounded-t-lg" src="../image/${x.image}" alt="product image">
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Seller: ${x.seller}</p>
